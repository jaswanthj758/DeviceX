 export const Testimonials = () => {
  return (
   <main>
         <section className='my-10 justify-between items-center mx-auto max-w-screen-xl'>
        <h1 className="text-2xl text-center font-semibold dark:text-slate-100 mb-5 underline underline-offset-8">Users About DeviceX</h1>    
